...
const MarketingCategoryPage: React.FC<MarketingCategoryPageProps> = ({ marca, carroceria }) => {
    ...
    return (
        <main className="bg-gray-50">
            {/* Hero Section */}
            <div className="relative h-64 sm:h-80 rounded-b-3xl overflow-hidden group">
                <img
                ...
                <div className="relative h-full flex flex-col justify-end p-6 sm:p-8 text-white">
                    <h1 className="text-3xl sm:text-5xl font-bold drop-shadow-lg leading-tight">
                        {seoContent.title}
                    </h1>
                    <p className="mt-2 text-base sm:text-lg drop-shadow-md max-w-2xl">
                    ...
                    <>
                        ...
                        <div className="mt-10 text-center">
                            <Link
                                ...
                                className="inline-block bg-primary-600 text-white font-semibold px-8 py-3 rounded-lg hover:bg-primary-700 transition-colors text-base shadow-md"
                            >
                     ...
                     <div className="text-center py-12 px-6 bg-white rounded-2xl shadow-sm">
                        ...
                        <h3 className="text-base font-semibold text-gray-800">No se encontraron autos</h3>
