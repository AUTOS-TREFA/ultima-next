    ...
    const updateApplicationStatus = async (lead: any, newStatus: string) => {
        ...
        try {
            ...
            if (newStatus === 'submitted') {
                ...
                toast.warning('Faltan Documentos', {
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <StatsCard
                    ...
                    value={String(leadsNeedingAction)}
                    change=""
                    changeType="neutral"
                    icon={Clock}
                    color="red"
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-4 font-medium text-gray-900">
                                                <Link href={`/escritorio/ventas/cliente/${lead.id}`} className="hover:underline text-primary-600 font-semibold">
