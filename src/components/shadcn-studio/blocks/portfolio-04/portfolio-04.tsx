    ...
    const fetchVehicles = async () => {
      try {
        ...
        const { data, error } = await supabase
          ...
          .select('id, slug, title, precio, feature_image, galeria_exterior, fotos_exterior_url, r2_feature_image, r2_gallery, separado, vendido, ordenstatus, exhibicion_inventario')
