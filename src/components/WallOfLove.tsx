...
const simulatedReviews: Review[] = [
    ...
    { source: 'Facebook', name: 'Carlos R.', rating: 5, text: 'Vendí mi auto a un precio justo y sin salir de casa. El equipo de TREFA se encargó de todo. Totalmente recomendado.', date: 'hace 1 mes' },
    { source: 'Google', name: 'Sofía L.', rating: 5, text: 'Tenía dudas sobre el financiamiento, pero el asesor me guió paso a paso y encontró la mejor opción para mí. Súper pacientes y profesionales.', date: 'hace 3 semanas' },
    { source: 'Google', name: 'Javier Torres', rating: 5, text: 'La calidad de los autos es de primera. Compré una camioneta y parece nueva. La inspección de 150 puntos realmente da confianza.', date: 'hace 5 días' },
    ...
    { source: 'Google', name: 'Ricardo Mendoza', rating: 5, text: 'La mejor experiencia de compra que he tenido. Sin presión, sin trucos, solo un servicio honesto y eficiente. El portal de clientes es muy útil.', date: 'hace 2 meses' },
    { source: 'Facebook', name: 'Ana Patricia', rating: 5, text: '¡Me encanta mi nuevo coche! Gracias a todo el equipo de TREFA por hacerlo tan fácil. El financiamiento que me consiguieron fue excelente.', date: 'hace 1 semana' },
    { source: 'Google', name: 'David Ortiz', rating: 5, text: 'Desde la valuación de mi auto antiguo hasta la compra del nuevo, todo el proceso fue impecable. Muy profesionales.', date: 'hace 3 meses' },
    ...
    { source: 'Google', name: 'Fernando Díaz', rating: 5, text: 'El auto está en excelentes condiciones. El único detalle fue que el papeleo final tomó un poco más de tiempo. Fuera de eso, todo perfecto.', date: 'hace 2 meses' },
    { source: 'Facebook', name: 'Gabriela Ríos', rating: 5, text: 'La atención por WhatsApp es súper rápida y eficiente. Resolvieron todas mis dudas al momento. ¡Gran servicio!', date: 'hace 3 semanas' },
    { source: 'Google', name: 'Andrés Paredes', rating: 5, text: 'El equipo de post-venta es genial. Tuvieron un pequeño detalle con la entrega y lo solucionaron de inmediato con un gesto comercial. Así se gana un cliente.', date: 'hace 1 mes' },
    ...
    { source: 'Facebook', name: 'Mónica S.', rating: 5, text: 'Dejé mi auto a consignación y se vendió rapidísimo. El equipo de marketing hizo un gran trabajo promocionándolo. Muy contenta con el servicio.', date: 'hace 1 semana' },
    { source: 'Google', name: 'Roberto Garza', rating: 5, text: 'Compré mi primer auto aquí y la experiencia fue de 10. Fernando, el asesor, fue súper amable y me ayudó a entender todo el proceso. El auto está impecable.', date: 'hace 4 días' }
];
