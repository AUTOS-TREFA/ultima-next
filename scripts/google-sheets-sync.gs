 ...
 *
 * UBICACIÓN: Este archivo está en el repositorio como referencia.
 * El código real debe estar en: Google Sheets > Extensions > Apps Script
 *
 * SETUP:
...
const CONFIG = {
  SUPABASE_URL: 'https://pemgwyymodlwabaexxrb.supabase.co',
  SUPABASE_KEY: 'YOUR_SERVICE_ROLE_KEY_HERE', // ← Reemplazar con la key real en Apps Script
